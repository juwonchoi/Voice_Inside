...
## 프로젝트 일정
<img src="https://github.com/juwonchoi/Voice_Inside/blob/master/screenshot/schedule.PNG" width="80%" height="60%" ></img>
  
  
## 구조도
### 전체 구조도
<img src="https://github.com/juwonchoi/Voice_Inside/blob/master/screenshot/all_structure.PNG" width="70%" height="50%" ></img>
### 파형 분석 구조
<img src="https://github.com/juwonchoi/Voice_Inside/blob/master/screenshot/wave_structure.PNG" width="70%" height="50%" ></img>
### 텍스트 분석 구조
<img src="https://github.com/juwonchoi/Voice_Inside/blob/master/screenshot/text_structure.PNG" width="70%" height="50%"></img>  
